...
let _ = require('lodash')
  ...
  , unsupportedSyntax = [
    [/\[Unsubscribe\]/i, '<strong>[Unsubscribe]</strong> tag was translated to <strong>&lt;a href="?" data-msys-unsubscribe="1"&gt;unsubscribe&lt;/a&gt;</strong>...<br>Remember to set that href attribute correctly.'],
    [/\[Unsubscribe_Preferences\]/i, '<strong>[Unsubscribe_Preferences]</strong> is unsupported. Treating as a normal substitution variable.']
  ];
