...
let _ = require('lodash')
  ...
  , unsupportedSyntax = [
    [/<%asm_global_unsubscribe_url%>/, '<strong>&lt;%asm_global_unsubscribe_url%&gt;</strong> tag was translated to <strong>&lt;a href="?" data-msys-unsubscribe="1"&gt;unsubscribe&lt;/a&gt;</strong><br>Remember to set that href attribute correctly.'],
    [/<%asm_group_unsubscribe_url%>/, "<strong>&lt;%asm_group_unsubscribe_url%&gt;</strong> is unsupported. Treating as a normal substitution variable." ],
    [/<%asm_preferences_url%>/, "<strong>&lt;%asm_preferences_url%&gt;</strong> is unsupported. Treating as a normal substitution variable." ]
  ];
